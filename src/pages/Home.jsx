    ...
    <div className="bg-[#DDDDDD] min-h-screen flex flex-col justify-start items-center p-5">
      ...
      <div className="flex flex-col-reverse items-center md:flex-row md:justify-between md:items-start w-full max-w-4xl">
        ...
        <div className="md:w-1/2 p-4 text-center md:text-left flex mt-10">
          ...
          >
           Cześć! Mam na imię Mateusz, jestem początkującym website 
           developerem z pasją do tworzenia nowoczesnych i responsywnych stron internetowych. 
           Specjalizuję się w technologiach <b>Frontend</b>, takich jak <b>HTML, CSS, JavaScript oraz React.js, </b> 
           ale cały czas staram się poszerzać moją wiedzę.
            Każdy nowy projekt traktuję jako okazję do nauki i rozwoju, a to portfolio jest zbiorem moich dotychczasowych osiągnięć.
